<?php
    class CompetenciasDistintivasDeLaCompetenciaEccs{
        ...
        function __construct(){
            $this->Table = "wp_tmp_cdcompetenciaeccs";
        }
        function GetDataReport(){
            ...
            while($row = mysqli_fetch_assoc($Query)){
                ...
                $Array[$i]['respuesta'] = $row['respuesta'];
                $Array[$i]['cuestionario'] = $row['cuestionario'];
                $i++;
            }
            return $Array;
        }
