...
<page pageset="old">
	<table class="table OneTDTH">
		...
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">En el cuadro adjunto se muestran los componentes relacionados con el producto de la competencia que de acuerdo al análisis, presentan PERFORMANCES POSITIVOS y NEGATIVOS en su desempeño.</td>
		</tr>
		<tr>
			<td>
...
<page pageset="old">
	<table class="table OneTDTH">
		...
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">En el cuadro adjunto se muestran acciones relacionadas con el precio de la competencia que de acuerdo al análisis, presentan PERFORMANCES POSITIVOS y NEGATIVOS en su desempeño.</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
...
<page pageset="old">
	<table class="table OneTDTH">
		...
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">En el cuadro adjunto se muestran aspectos relacionados con la distribución de su competencia que de acuerdo al análisis, presentan PERFORMANCES POSITIVOS y NEGATIVOS en su desempeño.</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
...
<page pageset="old">
	<table class="table OneTDTH">
		...
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">En el cuadro adjunto se muestran actividades comunicacionales de la mezcla promocional de su competencia que de acuerdo al análisis, presentan PERFORMANCES POSITIVOS y NEGATIVOS en su desempeño.</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
