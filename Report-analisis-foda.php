<?php /* Template Name: Report Analisis Foda */
    ob_start();
...
<page pageset="old">
	<table class="table">
		...
		<tr style="background-color: blue; color: #FFFFFF;">
			<td style="font-weight: bold; backgroubd-color: blue; color: #FFFFFF; " rowspan="<?php echo count($ArrayMayoresOportunidades) + 1; ?>">MAYORES OPORTUNIDADES DEL PRODUCTO</td>
		</tr>
		<?php
		...
		?>
		<tr style="background-color: #4997D0; color: #FFFFFF;">
			<td style="font-weight: bold; backgroubd-color: #4997D0; color: #FFFFFF; "  rowspan="<?php echo count($ArrayOportunidadesPromedio) + 1; ?>">OPORTUNIDADES PROMEDIO</td>
		</tr>
		<?php
		...
		<tr style="background-color: #C80815; color: #FFFFFF;">
			<td style="font-weight: bold; backgroubd-color: #C80815; color: #FFFFFF; "  rowspan="<?php echo count($ArrayMayoresAmenazas) + 1; ?>">MAYORES AMENAZAS DEL PRODUCTO</td>
		</tr>
		<?php
		...
		?>
		<tr style="background-color: #ff4d4d; color: #FFFFFF;">
			<td style="font-weight: bold; backgroubd-color: #ff4d4d; color: #FFFFFF; "  rowspan="<?php echo count($ArrayAmenazasPromedio) + 1; ?>">AMENAZAS PROMEDIO</td>
		</tr>
		<?php
