<?php /* Template Name: Report Plan Estratégico Promocional */
    ob_start();
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de publicidad</td>
		</tr>
		<tr>
			<td>
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de promocion de ventas</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de relaciones públicas</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de ventas personales</td>
		</tr>
		<tr>
			<td>
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de marketing directo</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
...
<page pageset="old">
	<table class="table OneTDTH">
		<tr>
			<td	style="background-color: orange; color: #FFFFFF;" colspan="2">Estratégias de marketing online</td>
		</tr>
		<tr>
			<td>
				<div style="background-color: blue; color: #FFFFFF;" class="Left">
