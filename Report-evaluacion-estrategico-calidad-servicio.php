<?php /* Template Name: Report Evaluacion Estrategico de Calidad de Servicio */
    ob_start();
...
<page pageset="old">
	...
	<table class="table">
		...
		<tr>
			<td style="color: #f68d1d;" rowspan="<?php echo count($PreferenciasProcesoRelacionalArray) + 1; ?>">preferencias en el PROCESO RELACIONAL(puntos de contacto)</td>
		</tr>
		<?php
		...
		?>
		<tr>
			<td style="color: #f68d1d;" rowspan="<?php echo count($PreferenciasServicioAlClienteArray) + 1; ?>">preferencias en el SERVICIO AL CLIENTE</td>
		</tr>
		<?php
		...
		?>
		<tr>
			<td style="color: #f68d1d;" rowspan="<?php echo count($PreferenciasServiciosComplementariosArray) + 1; ?>">preferencias en los SERVICIOS COMPLEMENTARIOS</td>
		</tr>
		<?php
...
<?php
	...
	$Dimensiones = array();
	$Dimensiones['confiabilidad'] = "Confiabilidad";
	$Dimensiones['tangibilidad'] = "Tangibilidad";
	$Dimensiones['cortesia'] = "Cortesía";
	$Dimensiones['empatia'] = "Empatía";
	$Dimensiones['excepciones'] = "Excepciones";
	$Dimensiones['informacion'] = "Información";
	$Dimensiones['consultoria'] = "Consultoría";
	$Dimensiones['capacidadrespuesta'] = "Capacidad de Respuesta";
	$Dimensiones['competencias'] = "Competencias";
	$Dimensiones['credibilidad'] = "Credibilidad";
	$Dimensiones['custodia'] = "Custodia";
	$Dimensiones['garantias'] = "Garantías";
	$Dimensiones['proximidad'] = "Proximidad";
	$Dimensiones['tiempoespera'] = "Tiempos de espera";
	$Dimensiones['localizacion'] = "Localización";
	$Dimensiones['horarios'] = "Horario de Servicio al Cliente";
...
<page pageset="old">
	...
	<table class="table">
		<tr>
			<th colspan="2" class="principal">2. DIAGNOSTICO DEL PROCESO RELACIONAL DEL CLIENTE CON EL SERVICIO (PUNTOS DE CONTACTO O TOUCHPOINTS)</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: blue; color: #FFFFFF;">2.1. ÁREAS DE ALTO DESEMPENO EN EL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: blue; color: #FFFFFF;">2.1.1. ÁREAS DE EXCELENCIA DEL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<?php
			foreach($LastAreaAO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: blue; color: #FFFFFF;">
								<td><?php echo "Excelente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en el servicio durante la fase: ".utf8_decode($Arreglo[$Valor2])." del proceso relacional del servicio."; ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
				}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #4997D0; color: #FFFFFF;">2.1.2. ÁREAS DE BUEN DESEMPENO DEL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<?php
			foreach($LastAreaAC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #4997D0; color: #FFFFFF;">
								<td><?php echo "Buen desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en el servicio durante la fase: ".utf8_decode($Arreglo[$Valor2])." del proceso relacional del servicio."; ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #C80815; color: #FFFFFF;">2.2. ÁREAS DE BAJO DESEMPENO EN EL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: #C80815; color: #FFFFFF;">2.2.1. ÁREAS DE DEFICIENCIA CRITICA DEL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<?php
			foreach($LastAreaRO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #C80815; color: #FFFFFF;">
								<td><?php echo "Deficiente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en el servicio durante la fase: ".utf8_decode($Arreglo[$Valor2])." del proceso relacional del servicio."; ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #ff4d4d; color: #FFFFFF;">2.2.2. ÁREAS DE MAL DESEMPENO DEL PROCESO RELACIONAL DEL SERVICIO</th>
		</tr>
		<?php
			foreach($LastAreaRC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #ff4d4d; color: #FFFFFF;">
								<td><?php echo "Mal desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en el servicio durante la fase: ".utf8_decode($Arreglo[$Valor2])." del proceso relacional del servicio."; ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
	...
	<table class="table">
		<tr>
			<th colspan="2" class="principal">3. DIAGNOSTICO DE LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: blue; color: #FFFFFF;">3.1. ÁREAS DE ALTO DESEMPENO EN LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: blue; color: #FFFFFF;">3.1.1. ÁREAS DE EXCELENCIA DE LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<?php
			foreach($LastAreaAO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: blue; color: #FFFFFF;">
								<td><?php echo "Excelente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #4997D0; color: #FFFFFF;">3.1.2. ÁREAS DE BUEN DESEMPENO DE LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<?php
			foreach($LastAreaAC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #4997D0; color: #FFFFFF;">
								<td><?php echo "Buen desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #C80815; color: #FFFFFF;">3.2. ÁREAS DE BAJO DESEMPENO EN LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<tr>
			<th colspan="2" style="background-color: #C80815; color: #FFFFFF;">3.2.1. ÁREAS DE DEFICIENCIA CRITICA DE LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<?php
			foreach($LastAreaRO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #C80815; color: #FFFFFF;">
								<td><?php echo "Deficiente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
		...
		?>
		<tr>
			<th colspan="2" style="background-color: #ff4d4d; color: #FFFFFF;">3.2.2. ÁREAS DE MAL DESEMPENO DE LOS SERVICIOS AL CLIENTE</th>
		</tr>
		<?php
			foreach($LastAreaRC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #ff4d4d; color: #FFFFFF;">
								<td><?php echo "Mal desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
								<td><?php echo $Estrategias["EST_".$Arreglo["Name_".$Valor2]]; ?></td>
							</tr>
						<?php
					}
	...
	<!--<table class="table OneTDTH">
		...
		<?php
			...
			<?php
			foreach($LastAreaAO["cortesia"] as $Valor){
				?>
					<tr style="background-color: blue; color: #FFFFFF;">
						<td><?php echo utf8_decode($Arreglo[$Valor]); ?></td>
					</tr>
			...
			<?php
			foreach($LastAreaAO["empatia"] as $Valor){
				?>
					<tr style="background-color: blue; color: #FFFFFF;">
						<td><?php echo utf8_decode($Arreglo[$Valor]); ?></td>
					</tr>
			...
			<?php
			foreach($LastAreaAO["custodia"] as $Valor){
				?>
					<tr style="background-color: blue; color: #FFFFFF;">
						<td><?php echo utf8_decode($Arreglo[$Valor]); ?></td>
					</tr>
			...
			<?php
			foreach($LastAreaAO["garantias"] as $Valor){
				?>
					<tr style="background-color: blue; color: #FFFFFF;">
						<td><?php echo utf8_decode($Arreglo[$Valor]); ?></td>
					</tr>
			...
			<?php
			foreach($LastAreaAO["horarios"] as $Valor){
				?>
					<tr style="background-color: blue; color: #FFFFFF;">
						<td><?php echo utf8_decode($Arreglo[$Valor]); ?></td>
					</tr>
	...
	<table class="table OneTDTH">
		<tr>
			<th class="principal">5. DIAGNOSTICO DE LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<tr>
			<th style="background-color: blue; color: #FFFFFF;">5.1. ÁREAS DE ALTO DESEMPENO EN LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<tr>
			<th style="background-color: blue; color: #FFFFFF;">5.1.1. ÁREAS DE EXCELENCIA DE LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<?php
			foreach($LastAreaAO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: blue; color: #FFFFFF;">
								<td><?php echo "Excelente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos o área de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
							</tr>
						<?php
					}
				}
		...
		?>
		<tr>
			<th style="background-color: #4997D0; color: #FFFFFF;">5.1.2. ÁREAS DE BUEN DESEMPENO DE LOS SERVICIOS SUPLEMENTARIOS</th>
		</tr>
		<?php
			foreach($LastAreaAC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #4997D0; color: #FFFFFF;">
								<td><?php echo "Buen desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos o área de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
							</tr>
						<?php
					}
				}
		...
		?>
		<tr>
			<th style="background-color: #C80815; color: #FFFFFF;">5.2. ÁREAS DE BAJO DESEMPENO EN LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<tr>
			<th style="background-color: #C80815; color: #FFFFFF;">5.2.1. ÁREAS DE DEFICIENCIA CRITICA DE LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<?php
			foreach($LastAreaRO as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #C80815; color: #FFFFFF;">
								<td><?php echo "Deficiente desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos o área de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
							</tr>
						<?php
					}
				}
		...
		?>
		<tr>
			<th style="background-color: #ff4d4d; color: #FFFFFF;">5.2.2. ÁREAS DE MAL DESEMPENO DE LOS SERVICIOS COMPLEMENTARIOS</th>
		</tr>
		<?php
			foreach($LastAreaRC as $Key => $Valor){
				if(count($Valor) > 0){
					foreach($Valor as $Key2 => $Valor2){
						?>
							<tr style="background-color: #ff4d4d; color: #FFFFFF;">
								<td><?php echo "Mal desempeño en cuanto a la(s) <strong>".strtoupper($Dimensiones[$Key])."</strong> ofrecida en los procesos o área de: ".utf8_decode($Arreglo[$Valor2]); ?></td>
							</tr>
						<?php
					}
				}
