...
?>
<page>
	<img style="width: 100%; height: 100%;" src="img/1-PORTADA.png" alt="">
</page>
<page backtop="90px" backbottom="90px" backimgx="center" backimgy="middle" backimgw="100%" backimg="img/4-HOJA-DE-CONTENIDO.png">
	<page_header>
        <img style="width: 100%;" src="img/header_report_bg.png" alt="">
    </page_header>
	...
	<table class="table">
		...
		<tr>
			<td>PROYECTO: </td>
			<td><?php echo $ServicioClass->post_title; ?></td>
		</tr>
		<tr>
			<td>CLIENTE:</td>
	...
	<page_footer>
        <img style="width: 100%;" src="img/footer_report_bg.png" alt="">
    </page_footer>
</page>
<page pageset="old">
	<?php
	...
	<table class="table">
		...
		<tr>
			<th >Preferencias hacia el PRODUCTO</th>
		</tr>
		<?php
		...
		?>
		<tr>
			<th >Preferencias sobre el PRECIO</th>
		</tr>
		<?php
		...
		?>
		<tr>
			<th >preferencias de DISTRIBUCION</th>
		</tr>
		<?php
		...
		?>
		<tr>
			<th>preferencias PROMOCIONALES</th>
		</tr>
		<?php
	...
	?>
		<table class="table OneTDTH">
			...
			<tr>
				<td><?php echo $Proposito . " " . $Porcentaje . " " . $Lapso; ?></td>
			</tr>
		</table>
...
<?php
    ...
    try
    {
        ...
        $html2pdf->Output('INFORME EJECUTIVO.pdf');
    }
